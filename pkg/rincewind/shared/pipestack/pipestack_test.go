...
func Test1_1(t *testing.T) {
	...
	require.True(t, ps.MatchBuff(alice))
	require.False(t, ps.MatchBuff(bob))
	require.True(t, ps.MatchBuff("Alice"))
	require.False(t, ps.MatchBuff("Bob"))
	require.Equal(t, alice, ps.PeekBuff())

	require.Equal(t, alice, ps.Next())
	require.False(t, ps.Empty())
	require.True(t, ps.EmptyStack())

	require.True(t, ps.MatchBuff(bob))
	require.False(t, ps.MatchBuff(alice))
	require.True(t, ps.MatchBuff("Bob"))
	require.False(t, ps.MatchBuff("Alice"))
	require.Equal(t, bob, ps.PeekBuff())
