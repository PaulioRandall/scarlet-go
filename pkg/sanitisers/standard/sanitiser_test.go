...
func Test_F3_Template(t *testing.T) {
	checkFormats(t,
		tok{M_TEMPLATE, `template`, 0, 0},
		tok{M_TEMPLATE, `"template"`, 0, 0},
	)
}

func Test_I1_Func(t *testing.T) {
	checkIgnores(t, tok{M_FUNC, "", 0, 0})
}

func Test_I2_Fix(t *testing.T) {
	checkIgnores(t, tok{M_FIX, "", 0, 0})
}

func Test_I3_ID(t *testing.T) {
	checkIgnores(t, tok{M_IDENTIFIER, "", 0, 0})
}

func Test_I4_Delim(t *testing.T) {
	checkIgnores(t, tok{M_DELIMITER, "", 0, 0})
}

func Test_I5_Assign(t *testing.T) {
	checkIgnores(t, tok{M_ASSIGN, "", 0, 0})
}

func Test_I6_Output(t *testing.T) {
	checkIgnores(t, tok{M_OUTPUT, "", 0, 0})
}

func Test_I7_BlockOpen(t *testing.T) {
	checkIgnores(t, tok{M_BLOCK_OPEN, "", 0, 0})
}

func Test_I8_BlockClose(t *testing.T) {
	checkIgnores(t, tok{M_BLOCK_CLOSE, "", 0, 0})
}

func Test_I9_ParenOpen(t *testing.T) {
	checkIgnores(t, tok{M_PAREN_OPEN, "", 0, 0})
}

func Test_I10_ParenClose(t *testing.T) {
	checkIgnores(t, tok{M_PAREN_CLOSE, "", 0, 0})
}

func Test_I11_List(t *testing.T) {
	checkIgnores(t, tok{M_LIST, "", 0, 0})
}

func Test_I12_Match(t *testing.T) {
	checkIgnores(t, tok{M_MATCH, "", 0, 0})
}

func Test_I13_GuardOpen(t *testing.T) {
	checkIgnores(t, tok{M_GUARD_OPEN, "", 0, 0})
}

func Test_I14_GuardClose(t *testing.T) {
	checkIgnores(t, tok{M_GUARD_CLOSE, "", 0, 0})
}

func Test_I15_Spell(t *testing.T) {
	checkIgnores(t, tok{M_SPELL, "", 0, 0})
}

func Test_I16_Number(t *testing.T) {
	checkIgnores(t, tok{M_NUMBER, "", 0, 0})
}

func Test_I17_Bool(t *testing.T) {
	checkIgnores(t, tok{M_BOOL, "", 0, 0})
}

func Test_I18_Add(t *testing.T) {
	checkIgnores(t, tok{M_ADD, "", 0, 0})
}

func Test_I19_Subtract(t *testing.T) {
	checkIgnores(t, tok{M_SUBTRACT, "", 0, 0})
}

func Test_I20_Multiply(t *testing.T) {
	checkIgnores(t, tok{M_MULTIPLY, "", 0, 0})
}

func Test_I21_Divide(t *testing.T) {
	checkIgnores(t, tok{M_DIVIDE, "", 0, 0})
}

func Test_I22_Remainder(t *testing.T) {
	checkIgnores(t, tok{M_REMAINDER, "", 0, 0})
}

func Test_I23_And(t *testing.T) {
	checkIgnores(t, tok{M_AND, "", 0, 0})
}

func Test_I24_Or(t *testing.T) {
	checkIgnores(t, tok{M_OR, "", 0, 0})
}

func Test_I25_Equal(t *testing.T) {
	checkIgnores(t, tok{M_EQUAL, "", 0, 0})
}

func Test_I26_NotEqual(t *testing.T) {
	checkIgnores(t, tok{M_NOT_EQUAL, "", 0, 0})
}

func Test_I27_LessThan(t *testing.T) {
	checkIgnores(t, tok{M_LESS_THAN, "", 0, 0})
}

func Test_I28_LessThanOrEqual(t *testing.T) {
	checkIgnores(t, tok{M_LESS_THAN_OR_EQUAL, "", 0, 0})
}

func Test_I29_MoreThan(t *testing.T) {
	checkIgnores(t, tok{M_MORE_THAN, "", 0, 0})
}

func Test_I30_MoreThanOrEqual(t *testing.T) {
	checkIgnores(t, tok{M_MORE_THAN_OR_EQUAL, "", 0, 0})
}

func Test_I31_Void(t *testing.T) {
	checkIgnores(t, tok{M_VOID, "", 0, 0})
}
...
func Test_R1_Newline(t *testing.T) {
	checkRemoves(t, tok{M_NEWLINE, "", 0, 0})
}

func Test_R2_Whitespace(t *testing.T) {
	checkRemoves(t, tok{M_WHITESPACE, "", 0, 0})
}

func Test_R3_Comment(t *testing.T) {
	checkRemoves(t, tok{M_COMMENT, "", 0, 0})
}

func Test_R4_Undefined(t *testing.T) {
	checkRemoves(t, tok{M_UNDEFINED, "", 0, 0})
}
...
func Test_R6_RepeatedTerminators(t *testing.T) {
	checkRemovesTerminators(t, tok{M_DELIMITER, "", 0, 0})
}

func Test_R7_RepeatedTerminators(t *testing.T) {
	checkRemovesTerminators(t, tok{M_BLOCK_OPEN, "", 0, 0})
}

func Test_R8_RepeatedTerminators(t *testing.T) {
	checkRemovesTerminators(t, tok{M_BLOCK_CLOSE, "", 0, 0})
}

func Test_R9_RepeatedTerminators(t *testing.T) {
	checkRemovesTerminators(t, tok{M_MATCH, "", 0, 0})
}

func Test_R10_RepeatedTerminators(t *testing.T) {
	checkRemovesTerminators(t, tok{M_LIST, "", 0, 0})
}
