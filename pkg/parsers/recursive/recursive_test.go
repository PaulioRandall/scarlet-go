...
func Test_E18_Increment(t *testing.T) {
	tests.Run(t, ParseAll, tests.E18_Increment)
}

func Test_E19_Decrement(t *testing.T) {
	tests.Run(t, ParseAll, tests.E19_Decrement)
}
