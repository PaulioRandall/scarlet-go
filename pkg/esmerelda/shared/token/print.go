...
func PrintAll(w io.StringWriter, tks []Token) error {

	tkf := findTkFmt(tks)

	for _, tk := range tks {
		e := writeLine(w, tk, tkf)
		if e != nil {
			return e
		}
	}
...
func findTkFmt(tks []Token) tkFmt {
...
func writeLine(w io.StringWriter, tk Token, tkf tkFmt) error {
...
func writeToken(w io.StringWriter, tk Token, tkf tkFmt) error {
...
func writeSnippet(w io.StringWriter, snip Snippet, tkf tkFmt) error {
