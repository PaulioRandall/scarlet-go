...
func TestNewline_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("\n", token.NEWLINE))
	doTest(t, "\n", exp)
}
...
func TestSpace_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(" ", token.SPACE))
	doTest(t, " ", exp)
}

func TestSpace_2(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("\t\r\v\f ", token.SPACE))
	doTest(t, "\t\r\v\f ", exp)
}

func TestComment_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("# :)", token.COMMENT))
	doTest(t, "# :)", exp)
}

func TestBool_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("true", token.TRUE))
	doTest(t, "true", exp)
}

func TestBool_2(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("false", token.FALSE))
	doTest(t, "false", exp)
}

func TestLoop_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("loop", token.LOOP))
	doTest(t, "loop", exp)
}

func TestIdent_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("abc", token.IDENT))
	doTest(t, "abc", exp)
}

func TestIdent_2(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("abc_xyz", token.IDENT))
	doTest(t, "abc_xyz", exp)
}

func TestTerminator_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(";", token.TERMINATOR))
	doTest(t, ";", exp)
}

func TestAssign_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(":=", token.ASSIGN))
	doTest(t, ":=", exp)
}

func TestDelim_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(",", token.DELIM))
	doTest(t, ",", exp)
}

func TestLeftParen_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("(", token.L_PAREN))
	doTest(t, "(", exp)
}

func TestRightParen_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(")", token.R_PAREN))
	doTest(t, ")", exp)
}

func TestLeftSquare_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("[", token.L_SQUARE))
	doTest(t, "[", exp)
}

func TestRightSquare_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("]", token.R_SQUARE))
	doTest(t, "]", exp)
}

func TestLeftCurly_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("{", token.L_CURLY))
	doTest(t, "{", exp)
}

func TestRightCurly_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("}", token.R_CURLY))
	doTest(t, "}", exp)
}

func TestVoid_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("_", token.VOID))
	doTest(t, "_", exp)
}

func TestAdd_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("+", token.ADD))
	doTest(t, "+", exp)
}

func TestSub_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("-", token.SUB))
	doTest(t, "-", exp)
}

func TestMul_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("*", token.MUL))
	doTest(t, "*", exp)
}

func TestDiv_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("/", token.DIV))
	doTest(t, "/", exp)
}

func TestRem_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("%", token.REM))
	doTest(t, "%", exp)
}

func TestAnd_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("&&", token.AND))
	doTest(t, "&&", exp)
}

func TestOr_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("||", token.OR))
	doTest(t, "||", exp)
}

func TestLessEqual_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("<=", token.LESS_EQUAL))
	doTest(t, "<=", exp)
}

func TestLess_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("<", token.LESS))
	doTest(t, "<", exp)
}

func TestMoreEqual_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(">=", token.MORE_EQUAL))
	doTest(t, ">=", exp)
}

func TestMore_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(">", token.MORE))
	doTest(t, ">", exp)
}

func TestEqual_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("==", token.EQUAL))
	doTest(t, "==", exp)
}

func TestNotEqual_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("!=", token.NOT_EQUAL))
	doTest(t, "!=", exp)
}

func TestSpell_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("@abc", token.SPELL))
	doTest(t, "@abc", exp)
}

func TestSpell_2(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("@a.b.c", token.SPELL))
	doTest(t, "@a.b.c", exp)
}
...
func TestString_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(`""`, token.STRING))
	doTest(t, `""`, exp)
}

func TestString_2(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok(`"abc"`, token.STRING))
	doTest(t, `"abc"`, exp)
}
...
func TestNumber_1(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("123", token.NUMBER))
	doTest(t, "123", exp)
}

func TestNumber_2(t *testing.T) {
	exp := tokentest.FeignSeries(lexeme.Tok("123.456", token.NUMBER))
