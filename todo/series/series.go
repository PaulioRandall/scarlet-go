...
func (s *Series) Next() token.Lexeme {
...
func (s *Series) Prev() token.Lexeme {
...
func (s *Series) Get() token.Lexeme {
	if s.mark.curr == nil {
		return token.Lexeme{}
	}
...
func (s *Series) LookAhead() token.Lexeme {
	if s.mark.next == nil {
		return token.Lexeme{}
	}
...
func (s *Series) LookBack() token.Lexeme {
	if s.mark.prev == nil {
		return token.Lexeme{}
	}
...
func (s *Series) Prepend(l token.Lexeme) {
...
func (s *Series) Append(l token.Lexeme) {
	atStart := s.mark.prev == nil && s.mark.curr == nil
...
func (s *Series) InsertAfter(l token.Lexeme) {
...
// A panic will ensue if the mark isn't pointing to an item.
func (s *Series) InsertBefore(l token.Lexeme) {
...
func (s *Series) Remove() token.Lexeme {
...
// code.
func (s *Series) Snippet() token.Snippet {
	if s.Empty() {
		return token.Snippet{}
	}
	return token.SuperSnippet(
